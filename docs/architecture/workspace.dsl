    ...
    model {
        ...
        ecommerceSystem = softwareSystem "Multi-Vendor E-commerce Platform" "Allows customers to purchase products from multiple vendors, vendors to manage their shops, and admins to configure the platform" {
            ...
            djangoAPI = container "Django REST API" "Provides e-commerce business logic and data access via RESTful API" "Django 4.2.7, DRF, Python 3.11" {
                ...
                productModel = component "Product Model" "Product details, pricing, stock, variants" "Django Model"
                categoryModel = component "Category Model" "Product categories and tags" "Django Model"
                brandModel = component "Brand Model" "Product brands" "Django Model"
                cartModel = component "Cart Model" "Shopping cart items" "Django Model"
                orderModel = component "Order Models" "CartOrder, CartOrderItem with delivery tracking" "Django Models"
                reviewModel = component "Review Model" "Product reviews and ratings" "Django Model"
                wishlistModel = component "Wishlist Model" "User wishlists" "Django Model"
                couponModel = component "Coupon Model" "Discount coupons and usage tracking" "Django Model"
                storeViews = component "Store Views" "Product list, detail, cart, checkout, payment" "DRF ViewSets"
        ...
        ecommerceSystem.djangoAPI.notificationComponent -> ecommerceSystem.database "Writes notifications"
        ecommerceSystem.djangoAPI.storeApp -> ecommerceSystem.djangoAPI.notificationComponent "Triggers on order events"
