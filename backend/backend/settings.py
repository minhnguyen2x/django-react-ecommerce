...
AWS_S3_REGION_NAME = env("AWS_S3_REGION_NAME", "us-east-1")  # Add region
AWS_S3_FILE_OVERWRITE = False
AWS_DEFAULT_ACL = None  # Don't set ACL - use bucket's default permissions
AWS_QUERYSTRING_AUTH = False  # Remove auth query strings from URLs
